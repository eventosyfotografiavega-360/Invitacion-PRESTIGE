...
const swiperHistoria = new Swiper('.swiper-historia', { loop: true, navigation: { nextEl: '.swiper-historia .swiper-button-next', prevEl: '.swiper-historia .swiper-button-prev' } });
